...
if(isset($_GET['cat']) && $_GET['cat'] == 'realestate'){
  ...
  <select  class="form-select" aria-label="Default select example" onchange="location=this.value" name="forWho" id="forWho">
    ...
    <option value="./tenders.php?cat=realestate&spType=rs&arg= &label=Real Estate" >Real Estate Sponsered</option>
    <option value="./tenders.php?cat=realestate&spType=ban&arg= &label=Bank Stokes" >Bank Stokes Sponsered</option>
    <option value="./tenders.php?cat=realestate&spType=ins&arg= &label=Insurance Stokes" >Insurance Stokes Sponsered </option>
  </select>
  </div>
...
if(isset($_GET['spType']) && $_GET['spType'] == 'rs'){
  ...
  <select  class="form-select" aria-label="Default select example" onchange="location=this.value" name="forWho" id="forWho">
  /tenders.php?cat=realestate&spType=rs&arg= &label=Real Estate
   <option selected><?php echo $lang['CategoryReal'] ?></option>
   <option value="./tenders.php?cat=realestate&spType=rs&arg= &label=Real Estate&dbType=Commercial RS">Commercial RS</option>
...
if(isset($_GET['cat'])){
  ...
  if(in_array($table, $rent_filter)){
    ...
    if(isset($_GET['type']) && $_GET['type'] == 'house' && $table == 'housesell'){
      ?>
        ...
        <select  class="form-select" aria-label="Default select example" onchange="location=this.value" name="forWho" id="forWho">
          ...
          <option value="./tenders.php?cat=housesell&type=house&arg=For Sell&label=House For Sell" >For Sell</option>
          <option value="./tenders.php?cat=housesell&type=house&arg=For Rent&label=House For Rent" >For Rent</option>
        </select>
        </div>
      <?php
      // tenders.php?cat=housesell&type=land&arg=For Sell&label=Land For Sell
    }elseif(isset($_GET['type']) && $_GET['type'] == 'land' && $table == 'housesell'){
      ?>
        <div  class="col-md-3" >
        <select  class="form-select" aria-label="Default select example" onchange="location=this.value" name="forWho" id="forWho">
          <option value=" " >For Rent or Sell</option>
          <option value="./tenders.php?cat=housesell&type=land&arg=For Sell&label=Land For Sell" >For Sell</option>
          <option value="./tenders.php?cat=housesell&type=land&arg=For Rent&label=Land For Rent" >For Rent</option>
        </select>
        </div>
      <?php   
      // tenders.php?cat=car&status=forRentOrSell&off=For Sell&label=Cars To Buy&type=   
    }elseif($table == 'car'){
      ?>
        <div  class="col-md-3" >
        <select  class="form-select" aria-label="Default select example" onchange="location=this.value" name="forWho" id="forWho">
          <option value=" " >For Rent or Sell</option>
          <option value="./tenders.php?cat=car&status=forRentOrSell&off=For Sell&label=Cars To Buy&type=   " >For Sell</option>
          <option value="./tenders.php?cat=car&status=forRentOrSell&off=For Rent&label=Cars For Rent&type=" >For Rent</option>
        </select>
        </div>
      <?php      
    }
    ...
    if(isset($_GET['spType']) && $_GET['spType'] == 'rs'){
      ...
      <select  class="form-select" aria-label="Default select example" onchange="location=this.value" name="forWho" id="forWho">
        <option value=" " >For Rent or Sell</option>
        <option value="./tenders.php?cat=realestate&spType=rs&arg=For Sell&label=Real Estate For Sell" >For Sell</option>
        <option value="./tenders.php?cat=realestate&spType=rs&arg=For Rent&label=Real Estate For Rent" >For Sell</option>
      </select>
      </div>
    <?php  
    }
  ...
  <div class="col-md-3">
      ...
      <?php
          if(isset($_GET['status'], $_GET['off'], $_GET['label'], $_GET['type'])){
            ?>
              <option value="./tenders.php?cat=<?php echo $tab ?>&status=<?php echo $_GET['status'] ?>&off=<?php echo $_GET['off'] ?>&dbType=<?php echo $sorted ?>&label=<?php echo $_GET['label'] ?>&type=<?php echo $_GET['type'] ?>">  <?php echo $sorted ?></a></option>
            <?php
          }elseif(isset($_GET['type'], $_GET['arg'], $_GET['label'], $_GET['cat'])){
            ?>
             <option value="./tenders.php?cat=<?php echo $tab ?>&type=<?php echo $_GET['type'] ?>&arg=<?php echo $_GET['arg'] ?>&dbType=<?php echo $sorted ?>&label=<?php echo $_GET['label'] ?>"><?php echo $sorted ?> </option>
            <?php
          }elseif(isset($_GET['type'])){
            ?>
              <option value="./tenders.php?cat=<?php echo $tab ?>&type=<?php echo $_GET['type'] ?>&dbType=<?php echo $sorted ?>&label=<?php echo $_GET['label'] ?>"><?php echo $sorted ?> </option>
            <?php
          }else{
            ?>
              <option value="./tenders.php?cat=<?php echo $tab ?>&dbType=<?php echo $sorted ?>"><?php echo $sorted ?> </option>
            <?php
          }
        ...
        <select class="form-select" aria-label="Default select example" name="positionType" id="inputGroupSelect01"  onchange="location=this.value;" >
          ...
          <?php
            foreach($city as $loc){
              ...
              <option value="<?php echo './tenders.php?'.$string?>&loc=<?php echo $loc?>" > <?php echo $loc ?></option>
...
<div class="input-group mb-3 col-md-3">
        <select class="form-select" aria-label="Default select example" name="positionType" id="inputGroupSelect01" onchange="location = this.value;" >
          ...
          <?php
            ...
            ?>
              <option value="tenders.php?<?php echo $string ?>&dyCol=forWho&dyArg=All" role="tab" aria-controls="home">All   </option>      
            <?php
            ?>
              <option value="tenders.php?<?php echo $string ?>&dyCol=forWho&dyArg=Private" role="tab" aria-controls="home">Private </option>        
            <?php
        
            ?>
             <option value="tenders.php?<?php echo $string ?>&dyCol=forWho&dyArg=Govormental Offices" role="tab" aria-controls="home">Govormental Offices   </option>     
            <?php
      
            ?>
            <option value="tenders.php?<?php echo $string ?>&dyCol=forWho&dyArg=NGO" role="tab" aria-controls="home">NGO     </option> 
            <?php
          
            ?>
             <option value="tenders.php?<?php echo $string ?>&dyCol=forWho&dyArg=Private Company" role="tab" aria-controls="home">Private Company  </option>      
            <?php
        ...
        <select class="form-select" aria-label="Default select example" name="status2" id="inputGroupSelect01" onchange="location = this.value;"  >
          ...
          <?php 
            ...
            for($y=1990;$y<=$cYear;$y++){
              ?>
              <option value="tenders.php?<?php echo $string ?>&dyCol=status&dyArg=<?php echo $y ?>" role="tab" aria-controls="home"> <?php echo $y ?></option>    
              <?php
            }
          ?>
        ...
        foreach($city as $loc){
          ...
          if(isset($_GET['type'], $_GET['arg']) || isset($_GET['spType'])){
            if($i == 0 && !isset($_GET['dyArg'])){ // this is the first subsity selecter and the !isset condition is the first element is selected if the dyArg is not set if it is the user has selected a subcity
              ...
              <option  value="tenders.php?<?php echo $string ?>&dyCol=subCity&dyArg=<?php echo $loc?>" role="tab" aria-controls="home"><?php echo $loc?></option>   
                <?php
            }else{
              ...
              <option value="tenders.php?<?php echo $string ?>&dyCol=subCity&dyArg=<?php echo $loc?>" role="tab" aria-controls="home"><?php echo $loc?></option> 
                ...
                ?>
              <option  value="tenders.php?<?php echo $string ?>&dyCol2=subCity&dyArg2=<?php echo $loc?>" role="tab" aria-controls="home"><?php echo $loc?></option>  
                <?php
              }
          ...
          for($y=1;$y<=30;$y++){
              ...
              //  if(isset($_GET['type'], $_GET['arg'])){
                 if(isset($_GET['dyCol']) && $_GET['dyCol'] == 'wereda'){
                  ...
                  ?>
                    <option   value="tenders.php?<?php echo $string ?>&dyCol=wereda&dyArg=<?php echo $zero.$y?>" role="tab" aria-controls="home"><?php echo '0'.$y ?></option>
                  <?php
                 }elseif(isset($_GET['dyCol']) && $_GET['dyCol'] != 'wereda'){
                   ?>
                   <option   value="tenders.php?<?php echo $string ?>&dyCol2=wereda&dyArg2=<?php echo $zero.$y?>" role="tab" aria-controls="home"><?php echo '0'.$y ?></option>
                   <?php
                 }
               ...
               if(isset($_GET['type'], $_GET['arg'])  || isset($_GET['spType'])){
                if(isset($_GET['dyCol']) && $_GET['dyCol'] == 'wereda'){
                  ...
                  $string = http_build_query($params); // to build t
                  ?>
                    <option   value="./tenders.php?<?php echo $string ?>&dyCol=wereda&dyArg=<?php echo $y?>" role="tab" aria-controls="home"><?php echo $y ?></option>
                  <?php
                 }else if(isset($_GET['dyCol']) && $_GET['dyCol'] != 'wereda'){
                   ?>
                   <option  value="./tenders.php?<?php echo $string ?>&dyCol2=wereda&dyArg2=<?php echo $y?>" role="tab" aria-controls="home"><?php echo $y ?></option>
                   <?php
                 }
...
$string = http_build_query($params); // to build the corrected requst to normal get query format
             ...
             for($y=1;$y<=30;$y++){
               if($y <= 9 ){
                if(isset($_GET['type'], $_GET['arg'])){
                 ?>
                 <option value="./tenders.php?<?php echo $string ?>&dyCol=wereda&dyArg=<?php echo $y?>"><?php echo '0'.$y ?></option>
                 <?php
                }
               }else{
                if(isset($_GET['type'], $_GET['arg']) ){
                ?>
                <option value="./tenders.php?<?php echo $string ?>&dyCol=wereda&dyArg=<?php echo $y?>"><?php echo $y ?></option>
                <?php
                }
               }
 ...
 <div class="row">
  ...
  <div class="col-md-8 shadow">
    ...
    if($_GET['cat'] == 'tender'){
      ...
      elseif($_SESSION['location'] != 'All' && !isset($_GET['dyCol'], $_GET['dyArg'])){
      ...
      }elseif(isset($_GET['month'], $_GET['year']) &&  $_SESSION['location'] == 'All' ){
        ...
        $fetchPost = monthYearDataLister($_GET['month'], $_GET['year'], 'tender', $startPage, $endPage );
      }elseif(isset($_GET['month'], $_GET['year']) &&  $_SESSION['location'] == 'All' ){
        function monthYearDataListerX($month, $year, $table, $limitStart, $limitEnd){
          include "./php/connect.php";
          $add = $_SESSION['location'];
          $q2 = "SELECT * FROM `$table` 
          WHERE (`address` = '$add') AND ( MONTH(`postedDate`) = $month or YEAR(`postedDate`)) = $year";
          $q = "SELECT * FROM `$table` 
          WHERE (`address` = '$add') AND ( MONTH(`postedDate`) = $month or YEAR(`postedDate`)) = $year LIMIT $limitStart, $limitEnd ";
          $ask = $mysql->query($q);
          $ask2 = $mysql->query($q2);
          return array($ask, $ask2);
        }
        $fetchPost = monthYearDataListerX($_GET['month'], $_GET['year'], 'tender', $startPage, $endPage );
      }
          ...
          ?>
            <div class="card mb-2">
              <div class="card-header">
                <a href="tenderdesc.php"><?php echo $row['title'] ?></a> 
              </div>
                <ul class="list-group list-group-flush bg-light">
                  <li class="list-group-item">Bid closing date: <?php echo ' '.$stdate ?> </li>
                  <li class="list-group-item">Bid opening date: <?php echo ' '.$exdate ?></li>
                  <li class="list-group-item">published on: <?php echo ' '.$p ?></li>
                </ul>
                <div class="card-footer">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      ...
                      if($days_between <=0 ){
                        ?>
                         <p >Bidding :<small class="text-danger"  > Closed</small>
                        <?php
                      }else{
                        ?>
                        <p >Bidding :<small class="text-success"  > Open</small>
                        <?php
                      }
                      ?>
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item">
      ...
      if($_SESSION['pgn']!= 1){
        ...
        ?>
        <a class="page-link" href="tenders.php?<?php echo $string ?>&end=<?php echo $_SESSION['pgn']-$pageNumberPerPAGE ?>"  >Previous</a>
        <?php
      }
      ?>
    </li>
            ...
            for($j= $_SESSION['pgn'];$j<=$pageCount;$j++){
              ...
              if(isset($_GET['page'])){
                if($_GET['page'] == $j){
                  ?>
                  <li class="page-item active"><a class="page-link" href="tenders.php?<?php echo $string ?>&page=<?php echo $j ?>&end=0"><?php echo $j ?></a></li>
                  <?php
                }else{
                  ?>
                  <li class="page-item"><a class="page-link " href="tenders.php?<?php echo $string ?>&page=<?php echo $j ?>&end=0"><?php echo $j ?></a></li>
                  <?php
                }
              }elseif($j == 1 ){
                ?>
            ...
            if($j + 1 < $pageCount){
              ?>
              <a class="page-link" href="tenders.php?<?php echo $string ?>&page=<?php echo $j+1 ?>&end=<?php echo $j+1 ?>">Next</a>
              <?php
            }
            ?>
    </li>
